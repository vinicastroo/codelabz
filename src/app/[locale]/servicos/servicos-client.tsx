  ...
  const services = [
    {
      ...
      icon: <Image src="/illustration-seo.svg" alt={t('service1Alt')} width={200} height={200} />,
    },
    {
      title: t('service2Title'),
      description: t('service2Desc'),
      features: [t('service2f1'), t('service2f2'), t('service2f3'), t('service2f4')],
      icon: <Image src="/illustration-dashboard.svg" alt={t('service2Alt')} width={200} height={200} />,
    },
    {
      title: t('service3Title'),
      description: t('service3Desc'),
      features: [t('service3f1'), t('service3f2'), t('service3f3'), t('service3f4')],
      icon: <Image src="/illustration-api.svg" alt={t('service3Alt')} width={200} height={200} />,
    },
    {
      title: t('service4Title'),
      description: t('service4Desc'),
      features: [t('service4f1'), t('service4f2'), t('service4f3'), t('service4f4')],
      icon: <Image src="/illustration-deploy.svg" alt={t('service4Alt')} width={200} height={200} />,
    },
    {
      title: t('service5Title'),
      description: t('service5Desc'),
      features: [t('service5f1'), t('service5f2'), t('service5f3'), t('service5f4')],
      icon: <Image src="/illustration-integration.svg" alt={t('service5Alt')} width={200} height={200} />,
    },
    {
      title: t('service6Title'),
      description: t('service6Desc'),
      features: [t('service6f1'), t('service6f2'), t('service6f3'), t('service6f4')],
      icon: <Image src="/illustration-automation.svg" alt={t('service6Alt')} width={200} height={200} />,
    },
  ]
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
          ...
          {services.map((service, i) => (
            ...
            >
              ...
              <div className="flex flex-col justify-center">
                <h2 className="text-xl font-display font-bold text-codelabz-dark mb-1">{service.title}</h2>
      ...
      <div className="container mx-auto px-6 py-24 text-center">
        <h2 className="text-2xl font-display font-bold mb-5 text-codelabz-dark">{t('techStack')}</h2>
